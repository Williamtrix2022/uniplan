-- ============================================================
-- UNIPLAN — ESQUEMA DE BASE DE DATOS
-- ============================================================
-- Reconstruido a partir de:
--   - docs/DB/base-de-datos.md (dump real de producción, AlwaysData,
--     15 jul 2026 — estudiantes, materias, tareas, horarios, notas,
--     eventos_calendario, sesiones_pomodoro, progreso_academico,
--     password_resets)
--   - backend/src/models/Notification.js (ensureTables(): notificaciones,
--     preferencias_notificacion)
--   - backend/seeds/sprint4_demo_seed.sql (calificaciones)
--
-- Este archivo NO contiene datos reales de estudiantes — solo DDL.
-- Sirve para levantar una base de datos local desde cero (ver
-- docker-compose.yml en la raíz del repo) y como referencia versionada
-- del esquema real, algo que hasta ahora no existía en el repositorio
-- (*.sql estaba en .gitignore sin excepción).
--
